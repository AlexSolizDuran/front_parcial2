...
const AdminCard: React.FC<AdminCardProps> = ({ title, description, href, Icon, bgColor }) => (
  <Link href={href} className={`block p-6 rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-1 transition-all duration-300 ease-in-out ${bgColor} text-white`}>
...
export default function AdminDashboardPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-extrabold text-gray-900 mb-8 text-center">Panel de Administración</h1>

      {/* Sección de Inventario */}
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-gray-800 mb-6 border-l-4 border-blue-500 pl-4">Gestión de Inventario</h2>
      ...
      {/* Sección de Usuarios */}
      <section className="mb-12">
        <h2 className="text-3xl font-bold text-gray-800 mb-6 border-l-4 border-yellow-500 pl-4">Gestión de Usuarios</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <AdminCard
            title="Clientes"
      ...
      {/* Sección de Ventas */}
      <section>
        <h2 className="text-3xl font-bold text-gray-800 mb-6 border-l-4 border-red-500 pl-4">Gestión de Ventas</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <AdminCard
